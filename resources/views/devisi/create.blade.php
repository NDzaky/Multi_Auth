...
<body style="background: rgb(27, 27, 27)">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h3 class="text-center my-4">Create Devisi</h3>
                    <hr>
                </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('devisi.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_devisi') is-invalid @enderror" name="nama_devisi" value="{{ old('nama_devisi') }}">
                                @error('nama_devisi')
